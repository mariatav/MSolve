...
namespace ISAAR.MSolve.PreProcessor.Elements
{
    public class Hexa8Memoizer
    {
        ...
        public Tuple<double[], double[,,]> GetIntegrationData(int element)//QUESTION: maybe the element id is useless, since we create one instance of Hexa8Memoizer per element??
        {
        ...
        public void SetIntegrationData(int element, Tuple<double[], double[,,]> integrationData)//QUESTION: maybe the element id is useless, since we create one instance of Hexa8Memoizer per element??
        {
    ...
    public class Hexa8WithStochasticMaterial : Hexa8
    {
        ...
        protected readonly Hexa8Memoizer memoizer;//QUESTION: why do we need one per element if it stores data of all the elements??
