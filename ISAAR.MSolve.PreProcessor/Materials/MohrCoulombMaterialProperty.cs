...
{
    public class MohrCoulombMaterialProperty : IIsotropicContinuumMaterial3DProperty
    {
        ...
        public MohrCoulombMaterialProperty(double youngModulus, double poissonRatio, double cohesion, double friction, double dilation)//TODOMaria: make this constructor private
        {
            ...
            if (poissonRatio == PoissonRatioForIncompressibleSolid)//QUESTION: Shouldn't this be poissonRatio >= .....???
            {
        ...
        {
            return new MohrCoulombMaterialState(this.YoungModulus, this.PoissonRatio, this.Cohesion, this.Friction, this.Dilation, coordinates);
        }
        ...
        private class MohrCoulombMaterialState : IIsotropicContinuumMaterial3DState
        {
