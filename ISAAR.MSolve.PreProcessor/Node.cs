...
namespace ISAAR.MSolve.PreProcessor
{
    ...
    public class Node
    {
        //private readonly List<DOFType> constraints = new List<DOFType>();//QUESTION: Maybe rename constraints to restraints??//removeMaria
        ...
        public override string ToString()
        {
            ...
            //}
            #endregion
            constraintsDescripton = constraintsDescripton.Length > 1 ? constraintsDescripton.Substring(0, constraintsDescripton.Length - 2) : constraintsDescripton;//TODOMaria rename constraintsDescripton to constraintsDescription
        ...
        public List<Constraint> Constraints //QUESTION: should we perhaps return IEnumerable??
        {
            get { return constraints; }
        }
